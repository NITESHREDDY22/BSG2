...
namespace TwoDLaserPack
{
    public class LineBasedLaser : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            startLaserSegmentLength = (int)Vector3.Distance(targetGo.transform.position,this.transform.position);
            Debug.LogWarning("startLaserSegmentLength" + startLaserSegmentLength);
